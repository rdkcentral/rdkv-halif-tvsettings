 ...
 *
 * @param[out] videoFormats    - List of available video formats.The memory must be allocated at caller end. Please refer ::tvVideoFormatType_t
 ...
 *
 * @param[out] videoSources    - List of available video sources.The memory must be allocated at caller end. Please refer ::tvVideoSrcType_t
 ...
 *
 * @param[out] dimmingModes    - List of dimming modes.The memory must be allocated at caller end. Please refer ::tvDimmingMode_t
 ...
 *
 * @param[out] dvModes[]            - List of available DV modes.The memory must be allocated at caller end. Refer ::tvDolbyMode_t @n
 ...
 *
 * @param[out] pictureModes              - List of available picture modes.The memory must be allocated at caller end. Valid values are as per values returned by pic_modes_t.name and pic_modes_t.values parameter(refer tvPQModeIndex_t).
